...
class FMark2 : AppCompatActivity()
{
  ...
  private lateinit var saveIndicator : SaveIndicator
  ...
  private fun startSignIn()
  {
    ...
    GlobalScope.launch(Dispatchers.Main) {
      val account = FDrive.getAccount(this@FMark2, GOOGLE_SIGN_IN_CODE)
  ...
  private fun startClientList(account : GoogleSignInAccount)
  {
    ...
    supportFragmentManager.beginTransaction().replace(R.id.list_fragment, ClientList2(this@FMark2, drive)).commit()
  }
