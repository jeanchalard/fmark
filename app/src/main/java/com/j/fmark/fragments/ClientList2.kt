...
import com.j.fmark.ClientAdapter2
import com.j.fmark.FMark2
import com.j.fmark.R
import com.j.fmark.drive.FDrive
import com.j.fmark.drive.FOLDER_MIME_TYPE
import com.j.fmark.drive.executeFully
...
class ClientList2(private val fmarkHost : FMark2, private val drive : Drive) : Fragment(), TextWatcher
{
  ...
  override fun onCreateView(inflater : LayoutInflater, container : ViewGroup?, savedInstanceState : Bundle?) : View
  {
    ...
    val field = view.findViewById<EditText>(R.id.client_name_search)
...
//    }
  ...
  private suspend fun readClients(searchString : String?)
  {
    ...
    val constraints = mutableListOf("trashed = false", "mimeType = '${FOLDER_MIME_TYPE}'", "'${dir.id}' in parents")
    if (null != searchString) constraints.add("name contains '${searchString}'")
    ...
    if (null == list.adapter)
    {
      ...
      list.adapter = ClientAdapter2(result, this)
    }
    else (list.adapter as ClientAdapter2).setSource(result)
  }
